...
function PartnerLogin() {
  ...
  return (
    <div className='login'>
        ...
        <div style={{display:"flex"}}><h2>PartnerLogin</h2><p style={{marginLeft:"5rem",marginTop:"1.5rem"}}>New User?<u style={{cursor:"pointer"}} onClick={()=>{navigate('/partnerRegister')}}> Register</u></p></div>
